...
public class Bot extends PircBot {
    ...
    public void onJoin(String channel, String sender, String message, String hostname) {
        ...
        sendMessage(channel, sender + ": Type 'Random Joke' to get a joke to cool your mind after looking at COVID Stats");
    ...
    public void onMessage(String channel, String sender, String login, String hostname, String message) {
        ...
        // Matching Regex for input type to call the Joke API
        else if (message.toLowerCase().contains("random joke")) {
            // Try and catch expression to get any undocumented errors
            try {
                String[] temp = JokeBot.randomJoke();   // Calling the function to get the random joke generated

                if (temp[0].equalsIgnoreCase("error")) {
                    // If API Call does not pass
                ...
                // try/catch Error for any undocumented Errors
        ...
        // If the user wants, a list of commands available
